...
(4, 'Varenie na Woku', 'Varenie', 'beginner', 'Zvládnite umenie ázijského varenia na vysokej teplote', 'Naučte sa techniky prípravy jedla na woku - od správnej teploty až po časovanie ingrediencií.', 10, '/images/topics/wok-cooking.jpg'),
...
(9, 'Farebná Harmónia', 'Dizajn', 'beginner', 'Ktoré farby sa k sebe hodia a prečo', 'Pochopte farebný kruh, komplementárne farby a ako vytvárať harmonické farebné kombinácie.', 10, '/images/topics/color-theory.jpg'),
...
('q1-pre-topic4',4,'Ktoré sú základné spôsoby tepelnej úpravy potravín?','multiple_choice','["Varenie, pečenie, dusenie, grilovanie","Mletie, sekanie, strúhanie","Oplachovanie, skladovanie","Fyzické miešanie"]',0,1),
('q2-pre-topic4',4,'Aký je hlavný rozdiel medzi varením, dusením a pečením?','multiple_choice','["Použitie rôznych korenín","Rôzny spôsob zahrievania a množstvo tekutiny","Dĺžka času skladovania","Tvar potraviny"]',1,2),
('q3-pre-topic4',4,'Prečo je dôležité správne nakrájať suroviny pred varením?','multiple_choice','["Aby jedlo vyzeralo pekne","Aby sa varili rovnomerne a rýchlejšie","Aby sa mohli lepšie uložiť do chladničky","Aby sa dalo ľahšie zmraziť"]',1,3),
('q4-pre-topic4',4,'Ktoré potraviny je vždy potrebné dobre umyť pred varením?','multiple_choice','["Mäso a ryby","Zelenina a ovocie","Cestoviny a ryža","Mliečne výrobky"]',1,4),
('q5-pre-topic4',4,'Prečo je dôležité používať správnu teplotu pri varení alebo smažení?','multiple_choice','["Aby sa jedlo neprehrialo alebo nepripálilo","Aby sa jedlo rýchlejšie ochladilo","Aby sa ušetrila elektrina","Aby sa dalo lepšie zamiešať"]',0,5),
('q6-pre-topic4',4,'Aké typy ohrevu poznáme a aký riad použiť?','multiple_choice','["Indukcia - magnetický hrniec, plyn - kovový hrniec, elektrika - všetky druhy","Indukcia - sklenené misky, plyn - plast, elektrika - len keramika","Indukcia - hliníkový riad, plyn - sklo, elektrika - len kov","Všetko je rovnaké"]',0,6),
('q7-pre-topic4',4,'Ktoré koreniny sú vhodné na dochutenie jedla počas varenia?','multiple_choice','["Soľ, korenie, cesnak, bylinky","Cukor a kakao","Múka a voda","Ocot a sóda"]',0,7),
('q8-pre-topic4',4,'Ako zistíš, že je jedlo dostatočne uvarené alebo opečené?','multiple_choice','["Podľa farby, vône a textúry","Podľa počtu ingrediencií","Podľa veľkosti hrnca","Podľa času po otvorení chladničky"]',0,8),
...
('q1-pre-topic9',9,'Čo je farebný kruh?','multiple_choice','["Typ maľby","Diagram znázorňujúci vzťahy medzi farbami","Farba kruhu","Nástroj na miešanie farieb"]',1,1),
('q2-pre-topic9',9,'Ktoré sú primárne farby?','multiple_choice','["Zelená, oranžová, fialová","Červená, žltá, modrá","Čierna, biela, sivá","Ružová, hnedá, tyrkysová"]',1,2),
('q3-pre-topic9',9,'Komplementárne farby sú oproti sebe na farebnom kruhu.','true_false','["Pravda","Nepravda"]',0,3),
('q4-pre-topic9',9,'Aká farba je komplementárna k modrej?','multiple_choice','["Zelená","Červená","Oranžová","Fialová"]',2,4),
('q5-pre-topic9',9,'Čo sú analógové farby?','multiple_choice','["Farby oproti sebe","Farby vedľa seba na farebnom kruhu","Čiernobiela škála","Primárne farby"]',1,5),
('q6-pre-topic9',9,'Teplé farby zahŕňajú červenú, oranžovú a žltú.','true_false','["Pravda","Nepravda"]',0,6),
('q7-pre-topic9',9,'Ktoré farby sú studené?','multiple_choice','["Červená, oranžová","Žltá, zelená","Modrá, zelená, fialová","Hnedá, sivá"]',2,7),
('q8-pre-topic9',9,'Čo je triádová farebná schéma?','multiple_choice','["Tri farby rovnako vzdialené na farebnom kruhu","Tri odtiene jednej farby","Čierna, biela a jedna farba","Primárne farby"]',0,8),
